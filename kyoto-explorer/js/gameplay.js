...
(function () {
    ...
    var ACHIEVEMENTS = [
        ...
        { id: 'kuji_draw', name: '運試しの始まり', desc: '初めておみくじを引く', icon: '📜', condition: function (s) { return s.kujiDrawn; } },
        { id: 'kuji_lucky', name: '強運の持ち主', desc: 'おみくじで大吉（または大大吉）を引く', icon: '✨', condition: function (s) { return s.luckyResult; } }
    ];
    ...
    window.KyotoGameplay = {
        ...
        stats: {
            ...
            kujiDrawn: false, luckyResult: false
        },
        npcs: [],
        bellCooldown: 0,
